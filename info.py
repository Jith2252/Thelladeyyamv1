...
BOT_TOKEN = environ.get('BOT_TOKEN', "5086970136:AAFcdTt3k4faBr-67iLWzydmLsmzRMw7pN8")
...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '969099516 904059063').split()]
